...
#
# Generated by Vivado on Mon Apr 06 11:42:09 JST 2020
...
elaborate()
{
  xelab --relax --debug typical --mt auto -L xil_defaultlib -L blk_mem_gen_v8_4_4 -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot top xil_defaultlib.top xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim top -key {Behavioral:sim_1:Functional:top} -tclbatch cmd.tcl -protoinst "protoinst_files/IB_RAM.protoinst" -protoinst "protoinst_files/clock_domain.protoinst" -log simulate.log
}
