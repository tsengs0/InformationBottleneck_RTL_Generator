...
always @(posedge ram_clk) begin
    if(ram_sel[1:0] == 2'b01) interBank_data_ram0[31:0] <= interBank_write_data[31:0];
    else interBank_data_ram0[31:0] <= {8{4'h1}};//32'd0;
end 

always @(posedge ram_clk) begin
    if(ram_sel[1:0] == 2'b10) interBank_data_ram1[31:0] <= interBank_write_data[31:0];
    else interBank_data_ram1[31:0] <= {8{4'hf}};//32'd0;
end 

always @(posedge ram_clk) begin
    if(ram_sel[1:0] == 2'b11) interBank_data_ram2[31:0] <= interBank_write_data[31:0];
    else interBank_data_ram2[31:0] <= 32'd0;
end 

always @(posedge ram_clk) begin
    if(ram_sel[1:0] == 2'b00) interBank_data_ram3[31:0] <= interBank_write_data[31:0];
    else interBank_data_ram3[31:0] <= 32'd0;
end  
*/
