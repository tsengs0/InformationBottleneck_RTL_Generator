...
set_property PACKAGE_PIN K28 [get_ports sys_clk_p]
set_property IOSTANDARD LVDS_25 [get_ports sys_clk_p]
set_property PACKAGE_PIN K29 [get_ports sys_clk_n]
...
# DIP SW
set_property PACKAGE_PIN Y28  [get_ports {reset}]#set_property PACKAGE_PIN Y28  [get_ports {dipsw[3]}]
...
set_property IOSTANDARD LVCMOS25 [get_ports {reset}]#set_property IOSTANDARD LVCMOS25 [get_ports {dipsw[3]}]
