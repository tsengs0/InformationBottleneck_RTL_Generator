...
HD_PWD='/home/s1820419/LDPC_MinorResearch/GeneratedDecoders/204.33.486/RTL/symmetry_ib_lut_structure/symmetry_ib_lut_structure.runs/CN-204.102-f03.eval'
cd "$HD_PWD"
...
EAStep vivado -log cnu6_204_102.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source cnu6_204_102.tcl
