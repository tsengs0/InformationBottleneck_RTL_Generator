...
# DVE full session
# Saved on Mon Oct 26 10:51:08 2020
# Designs open: 1
#   Sim: /mnt/fs800/home/s1610105/Documents/research/Doctor/LDPC_MinorResearch/DecodingProcessControl/wr_update_handshake
# Toplevel windows open: 1
# 	TopLevel.1
#   Schematic.1: cnu_wr_update_handshake_tb.handshake_u0
#   Source.1: cnu_wr_update_handshake_tb.handshake_u0
#   Group count = 0
...
gui_show_window -window ${TopLevel.1} -show_state normal -rect {{2736 23} {4655 1079}}
...
gui_update_layout -id ${HSPane.1} {{left 0} {top 0} {width 185} {height 783} {dock_state left} {dock_on_new_line true} {child_hier_colhier 174} {child_hier_coltype 20} {child_hier_colpd 0} {child_hier_col1 0} {child_hier_col2 1} {child_hier_col3 -1}}
...
gui_set_window_pref_key -window ${DLPane.1} -key dock_height -value_type integer -value 806
gui_set_window_pref_key -window ${DLPane.1} -key dock_offset -value_type integer -value 0
gui_update_layout -id ${DLPane.1} {{left 0} {top 0} {width 156} {height 783} {dock_state left} {dock_on_new_line true} {child_data_colvariable 140} {child_data_colvalue 100} {child_data_coltype 40} {child_data_col1 0} {child_data_col2 1} {child_data_col3 2}}
...
gui_open_source -id ${Source.1}  -replace -active cnu_wr_update_handshake_tb.handshake_u0 /mnt/fs800/home/s1610105/Documents/research/Doctor/LDPC_MinorResearch/DecodingProcessControl/wr_update_handshake.v
...
gui_sch_show -window ${Schematic.1} -name cnu_wr_update_handshake_tb.handshake_u0
gui_show_pin_value_annotate [gui_window_hier_name -window ${Schematic.1}]
gui_zoom -window ${Schematic.1} -rect { {-931 -59171} {133905 4348} }
