...
# JA Pmod - Bank 13 
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN Y11  [get_ports {t_c[0]}];  # "JA1"
set_property PACKAGE_PIN AA8  [get_ports {t_c[1]}];  # "JA10"
set_property PACKAGE_PIN AA11 [get_ports {t_c[2]}];  # "JA2"
set_property PACKAGE_PIN Y10  [get_ports {t_c[3]}];  # "JA3"
set_property PACKAGE_PIN AA9  [get_ports {y0[0]}];  # "JA4"
set_property PACKAGE_PIN AB11 [get_ports {y0[1]}];  # "JA7"
set_property PACKAGE_PIN AB10 [get_ports {y0[2]}];  # "JA8"
set_property PACKAGE_PIN AB9  [get_ports {y0[3]}];  # "JA9"


# ----------------------------------------------------------------------------
# JB Pmod - Bank 13
# ---------------------------------------------------------------------------- 
set_property PACKAGE_PIN W12 [get_ports {y1[0]}];  # "JB1"
set_property PACKAGE_PIN W11 [get_ports {y1[1]}];  # "JB2"
set_property PACKAGE_PIN V10 [get_ports {y1[2]}];  # "JB3"
set_property PACKAGE_PIN W8  [get_ports {y1[3]}];  # "JB4"
