...
#
# Generated by export_simulation on Wed Feb 26 02:27:24 JST 2020
#
################################################################################
...
'-reset_run' switch to the './cnu_ib_lut_ram.sh' script.

./cnu_ib_lut_ram.sh -reset_run
...
./cnu_ib_lut_ram.sh -noclean_files

For more information on the script, please type './cnu_ib_lut_ram.sh -help'.
