...
page_align_depth_1 #(.QUAN_SIZE (QUAN_SIZE)) page_align_u25(.align_out(msg_out_25), .align_target_in (msg_mux_out[25]), .sys_clk(sys_clk), .rstn(rstn));
page_align_depth_1 #(.QUAN_SIZE (QUAN_SIZE)) page_align_u26(.align_out(msg_out_26), .align_target_in (msg_mux_out[26]), .sys_clk(sys_clk), .rstn(rstn));
page_align_depth_1 #(.QUAN_SIZE (QUAN_SIZE)) page_align_u27(.align_out(msg_out_27), .align_target_in (msg_mux_out[27]), .sys_clk(sys_clk), .rstn(rstn));
page_align_depth_1 #(.QUAN_SIZE (QUAN_SIZE)) page_align_u28(.align_out(msg_out_28), .align_target_in (msg_mux_out[28]), .sys_clk(sys_clk), .rstn(rstn));
page_align_depth_1 #(.QUAN_SIZE (QUAN_SIZE)) page_align_u29(.align_out(msg_out_29), .align_target_in (msg_mux_out[29]), .sys_clk(sys_clk), .rstn(rstn));
