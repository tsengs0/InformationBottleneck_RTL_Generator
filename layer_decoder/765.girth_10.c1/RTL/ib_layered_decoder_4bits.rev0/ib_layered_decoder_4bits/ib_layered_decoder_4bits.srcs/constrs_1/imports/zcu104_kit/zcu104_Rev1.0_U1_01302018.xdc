...
#set_property PACKAGE_PIN B5 [get_ports ready_work]
#set_property IOSTANDARD LVCMOS33 [get_ports ready_work]
#set_property PACKAGE_PIN A5 [get_ports is_awgn_out]
#set_property IOSTANDARD LVCMOS33 [get_ports is_awgn_out]