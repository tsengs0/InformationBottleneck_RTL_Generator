...
#
# Generated by export_simulation on Sat Jun 12 19:26:37 JST 2021
#
################################################################################
...
./tb_mem_subsystem_top_submatrix_1.sh
...
'-reset_run' switch to the './tb_mem_subsystem_top_submatrix_1.sh' script.

./tb_mem_subsystem_top_submatrix_1.sh -reset_run
...
./tb_mem_subsystem_top_submatrix_1.sh -noclean_files

For more information on the script, please type './tb_mem_subsystem_top_submatrix_1.sh -help'.
