...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set pl_fifo_wr_clk [ create_bd_port -dir I -type clk pl_fifo_wr_clk ]
  set result_fifo_in [ create_bd_port -dir I -from 31 -to 0 result_fifo_in ]
  set result_fifo_we [ create_bd_port -dir I result_fifo_we ]
  ...
  # Create instance: axis_pl2ps_fifo_1, and set properties
  set axis_pl2ps_fifo_1 [ create_bd_cell -type ip -vlnv xilinx.com:user:axis_pl2ps_fifo:1.1 axis_pl2ps_fifo_1 ]
  ...
  connect_bd_intf_net -intf_net axis_pl2ps_fifo_1_M_AXIS [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_pl2ps_fifo_1/M_AXIS]
  ...
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_0/gpio_io_o] [get_bd_pins axis_pl2ps_fifo_1/En]
  connect_bd_net -net axi_gpio_1_gpio_io_o [get_bd_pins axi_gpio_1/gpio_io_o] [get_bd_pins axis_pl2ps_fifo_1/FrameSize]
  connect_bd_net -net pl_fifo_wr_clk_1 [get_bd_ports pl_fifo_wr_clk] [get_bd_pins axis_pl2ps_fifo_1/pl_fifo_wr_clk]
  connect_bd_net -net result_fifo_in_1 [get_bd_ports result_fifo_in] [get_bd_pins axis_pl2ps_fifo_1/result_fifo_in]
  connect_bd_net -net result_fifo_we_1 [get_bd_ports result_fifo_we] [get_bd_pins axis_pl2ps_fifo_1/result_fifo_we]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_gpio_0/s_axi_aresetn] [get_bd_pins axi_gpio_1/s_axi_aresetn] [get_bd_pins axi_smc/aresetn] [get_bd_pins axis_pl2ps_fifo_1/m_axis_aresetn] [get_bd_pins axis_pl2ps_fifo_1/s_axis_aresetn] [get_bd_pins ps8_0_axi_periph/ARESETN] [get_bd_pins ps8_0_axi_periph/M00_ARESETN] [get_bd_pins ps8_0_axi_periph/M01_ARESETN] [get_bd_pins ps8_0_axi_periph/M02_ARESETN] [get_bd_pins ps8_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins axis_pl2ps_fifo_1/AXI_En] [get_bd_pins xlconstant_0/dout]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins axi_dma_0/s_axis_s2mm_tkeep] [get_bd_pins xlconstant_1/dout]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_gpio_0/s_axi_aclk] [get_bd_pins axi_gpio_1/s_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins axis_pl2ps_fifo_1/m_axis_aclk] [get_bd_pins axis_pl2ps_fifo_1/s_axis_aclk] [get_bd_pins ps8_0_axi_periph/ACLK] [get_bd_pins ps8_0_axi_periph/M00_ACLK] [get_bd_pins ps8_0_axi_periph/M01_ACLK] [get_bd_pins ps8_0_axi_periph/M02_ACLK] [get_bd_pins ps8_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp1_fpd_aclk]
