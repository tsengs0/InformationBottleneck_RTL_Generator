...
proc create_root_design { parentCell } {
  ...
  # Create ports
  set axi_wr_end [ create_bd_port -dir O -type data axi_wr_end ]
  set axi_wr_first_shift [ create_bd_port -dir O -type data axi_wr_first_shift ]
  set axi_wr_next_shift [ create_bd_port -dir O -type data axi_wr_next_shift ]
  set m00_axi_aclk [ create_bd_port -dir O -type clk m00_axi_aclk ]
  set m00_axi_init_axi_txn [ create_bd_port -dir I -type data m00_axi_init_axi_txn ]
  set m00_axi_wr_intr_en [ create_bd_port -dir O -type intr m00_axi_wr_intr_en ]
  set m_axi_arestn [ create_bd_port -dir O -from 0 -to 0 -type data m_axi_arestn ]
  set pl_ps_ext_intr [ create_bd_port -dir I -type intr pl_ps_ext_intr ]
  set_property -dict [ list \
   CONFIG.SENSITIVITY {EDGE_RISING} \
 ] $pl_ps_ext_intr
  set result_packet_in [ create_bd_port -dir I -from 31 -to 0 -type data result_packet_in ]
  ...
  # Create instance: full_axi4_burst_wr_0, and set properties
  set full_axi4_burst_wr_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:full_axi4_burst_wr:1.1 full_axi4_burst_wr_0 ]
  set_property -dict [ list \
   CONFIG.C_M00_AXI_BURST_LEN {8} \
 ] $full_axi4_burst_wr_0
  ...
  connect_bd_intf_net -intf_net full_axi4_burst_wr_0_M00_AXI [get_bd_intf_pins axi_smc/S00_AXI] [get_bd_intf_pins full_axi4_burst_wr_0/M00_AXI]

  # Create port connections
  connect_bd_net -net full_axi4_burst_wr_0_axi_wr_end [get_bd_ports axi_wr_end] [get_bd_pins full_axi4_burst_wr_0/axi_wr_end]
  connect_bd_net -net full_axi4_burst_wr_0_axi_wr_first_shift [get_bd_ports axi_wr_first_shift] [get_bd_pins full_axi4_burst_wr_0/axi_wr_first_shift]
  connect_bd_net -net full_axi4_burst_wr_0_axi_wr_intr_en [get_bd_ports m00_axi_wr_intr_en] [get_bd_pins full_axi4_burst_wr_0/axi_wr_intr_en]
  connect_bd_net -net full_axi4_burst_wr_0_axi_wr_next_shift [get_bd_ports axi_wr_next_shift] [get_bd_pins full_axi4_burst_wr_0/axi_wr_next_shift]
  connect_bd_net -net m00_axi_init_axi_txn_1 [get_bd_ports m00_axi_init_axi_txn] [get_bd_pins full_axi4_burst_wr_0/m00_axi_init_axi_txn]
  connect_bd_net -net pl_ps_ext_intr_1 [get_bd_ports pl_ps_ext_intr] [get_bd_pins zynq_ultra_ps_e_0/pl_ps_irq0]
  connect_bd_net -net result_packet_in_1 [get_bd_ports result_packet_in] [get_bd_pins full_axi4_burst_wr_0/result_packet_in]
  connect_bd_net -net rst_ps8_0_100M_peripheral_aresetn [get_bd_ports m_axi_arestn] [get_bd_pins axi_smc/aresetn] [get_bd_pins full_axi4_burst_wr_0/m00_axi_aresetn] [get_bd_pins rst_ps8_0_100M/peripheral_aresetn]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_ports m00_axi_aclk] [get_bd_pins axi_smc/aclk] [get_bd_pins full_axi4_burst_wr_0/m00_axi_aclk] [get_bd_pins rst_ps8_0_100M/slowest_sync_clk] [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins zynq_ultra_ps_e_0/saxihp0_fpd_aclk]
  ...
  assign_bd_address -offset 0x00000000 -range 0x80000000 -target_address_space [get_bd_addr_spaces full_axi4_burst_wr_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_DDR_LOW] -force
  assign_bd_address -offset 0xFF000000 -range 0x01000000 -target_address_space [get_bd_addr_spaces full_axi4_burst_wr_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_LPS_OCM] -force
  assign_bd_address -offset 0xC0000000 -range 0x20000000 -target_address_space [get_bd_addr_spaces full_axi4_burst_wr_0/M00_AXI] [get_bd_addr_segs zynq_ultra_ps_e_0/SAXIGP2/HP0_QSPI] -force
