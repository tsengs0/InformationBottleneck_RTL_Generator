...
--               /home/s1820419/Xilinx/Vivado/project/AXI.UART.customIP/AXI.UART.customIP.srcs/sources_1/bd/clock_domain/ip/clock_domain_clk_wiz_0_0/clock_domain_clk_wiz_0_0_sim_netlist.vhdl
...
entity clock_domain_clk_wiz_0_0_clock_domain_clk_wiz_0_0_clk_wiz is
  port (
  ...
  attribute ORIG_REF_NAME of clock_domain_clk_wiz_0_0_clock_domain_clk_wiz_0_0_clk_wiz : entity is "clock_domain_clk_wiz_0_0_clk_wiz";
end clock_domain_clk_wiz_0_0_clock_domain_clk_wiz_0_0_clk_wiz;

architecture STRUCTURE of clock_domain_clk_wiz_0_0_clock_domain_clk_wiz_0_0_clk_wiz is
  signal clk_in1_clock_domain_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out1_clock_domain_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out2_clock_domain_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out3_clock_domain_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out4_clock_domain_clk_wiz_0_0 : STD_LOGIC;
  signal clk_out5_clock_domain_clk_wiz_0_0 : STD_LOGIC;
...
clkout3_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out3_clock_domain_clk_wiz_0_0,
      O => clk_out3
    );
clkout4_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out4_clock_domain_clk_wiz_0_0,
      O => clk_out4
    );
clkout5_buf: unisim.vcomponents.BUFGCE
    generic map(
      ...
      SIM_DEVICE => "ULTRASCALE_PLUS"
        ...
        port map (
      CE => '1',
      I => clk_out5_clock_domain_clk_wiz_0_0,
      O => clk_out5
    );
mmcme4_adv_inst: unisim.vcomponents.MMCME4_ADV
    generic map(
      ...
      CLKOUT2 => clk_out3_clock_domain_clk_wiz_0_0,
      CLKOUT2B => NLW_mmcme4_adv_inst_CLKOUT2B_UNCONNECTED,
      CLKOUT3 => clk_out4_clock_domain_clk_wiz_0_0,
      CLKOUT3B => NLW_mmcme4_adv_inst_CLKOUT3B_UNCONNECTED,
      CLKOUT4 => clk_out5_clock_domain_clk_wiz_0_0,
...
entity clock_domain_clk_wiz_0_0 is
  ...
  attribute NotValidForBitStream of clock_domain_clk_wiz_0_0 : entity is true;
end clock_domain_clk_wiz_0_0;

architecture STRUCTURE of clock_domain_clk_wiz_0_0 is
begin
inst: entity work.clock_domain_clk_wiz_0_0_clock_domain_clk_wiz_0_0_clk_wiz
     port map (
      clk_in1_n => clk_in1_n,
      clk_in1_p => clk_in1_p,
      clk_out1 => clk_out1,
